...
public class MailUtils {
	// 发件人的邮箱
	public static String fromEmailAccount = "runlei123@126.com";
	// 发件人的密码(某些邮箱服务器为了增加邮箱本身密码的安全性，给 SMTP 客户端设置了“授权码”，此时邮箱密码需要使用“授权码”。
	public static String fromEmailPassword = "bejavaer123";
	// 发件人邮箱的 SMTP 服务器地址，一般格式为: smtp.xxx.com
	public static String fromEmailSMTPHost = "smtp.126.com";
	// 收件人邮箱
	public static String toEMailAccount = "rainy152@sina.com";
...
//		message.setRecipient(MimeMessage.RecipientType.BCC, new InternetAddress("ff@receive.com", "USER_FF", "UTF-8"));
		...
		String url = "http://localhost:8080/DemoShoppingMall01/CustomerServlet?method=active&code=" + emailMsg;
		String content = "<h1>来自DemoShoppingMall01的激活邮件!请点击以下链接激活账户!</h1><h3><a href='" + url + "'>" + url
				+ "</a></h3>";
...
//		MailUtils.testMail();
		MailUtils.sendMail("run@126.com", "1234567890");
